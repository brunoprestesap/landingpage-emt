  ...
  return (
    <div id="contact" className="my-8">
      <div className="flex justify-center gap-3 mb-8">
        <h2 className="flex gap-2 text-4xl font-bold text-center text-[#606C38]">
          <FaMapMarkedAlt color="283618" />
          ONDE
        </h2>
        <h2 className="text-4xl font-bold text-center text-[#283618] underline decoration-[#A86A24] underline-offset-8">
          ESTAMOS
        </h2>
      </div>
      ...
      <div className="mx-5 flex flex-col md:flex-row items-start justify-center">
        <div className="flex flex-col w-full">
          <div className="w-full flex justify-center">
            <a
              ...
              rel="noreferrer"
            >
              <button className="bg-[#283618] rounded-lg w-full py-3 px-8 mb-5 text-center hover:border hover:border-stone-100 hover:shadow-xl">
        ...
        <div className="w-full px-5 my-5 md:my-0">
          <div className="w-full mb-8 flex justify-center items-center">
            <h1 className="text-4xl font-bold text-center text-[#283618] underline decoration-[#A86A24] underline-offset-8">
              CONTATO
            </h1>
          </div>

          <div className="w-full p-5 bg-[#606C38] shadow-2xl shadow-stone-500/50 rounded-xl">
            <form
            ...
            >
              <div className="grid md:grid-cols-2 gap-2 w-full">
                <div className="flex flex-col">
                  <label className="text-sm py-2 text-[#FEFAE0] font-medium">
                    Nome
                  </label>
                  <input
              ...
              <div className="flex flex-col py-2">
                ...
                <textarea
                  className="rounded-lg p-1 border-[#003E53]-300 focus:ring focus:ring-[#283618]"
                  rows="5"
                  name="message"
                ></textarea>
              </div>
              <button className="bg-[#283618] hover:bg-stone-700 text-gray-100 mt-4 w-full p-4 rounded-lg">
